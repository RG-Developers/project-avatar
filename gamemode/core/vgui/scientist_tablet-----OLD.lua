...
local console_log = {"FRACTALOS v1.0", 
...
function Tablet:Init()
    ...
    self.Main.Paint = function()
        ...
        for lineNum = 1,  math.Clamp(#console_log, 0, 50) do
            draw.DrawText(console_log[#console_log-lineNum+1], "Default", 80, ScrH()-80-(12*lineNum), Color( 240, 240, 240, math.random(230,255)))
        end
        if waitcoro then
